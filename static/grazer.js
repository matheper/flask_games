...
var Enemy = function(tier){
    ...
    if(tier==1){
        sprite.src= "static/images/alien.gif"
    }
    if(tier==2){
        sprite.src= "static/images/alien2.gif"
    }
    if(tier==3){
        sprite.src= "static/images/alien3.gif"
    }
    return {
        x:  Math.random() * 320,
        y: -5,
...
var Bullet = function(friend, who) {
    ...
    var sprite = new Image();
    if(friend)
        sprite.src = "static/images/bullet.png";
    else sprite.src = "static/images/bullet2.png";
...
function startUp(){
    ...
    player.sprite.src = "static/images/nave.gif";
    player.core.sprite = new Image();
    player.core.sprite.src = "static/images/core.png"
    game.background = new Image();
    game.background.src = "static/images/bg.jpg";
}
